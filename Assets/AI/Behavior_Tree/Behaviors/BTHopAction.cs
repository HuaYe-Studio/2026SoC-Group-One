...
public class BTHopAction : BTNode
{
    ...
    /// <param name="isDebugLogEnabled">调试日志开关查询委托，可为null</param>
    public BTHopAction(FrogAI frog, System.Func<bool> isDebugLogEnabled = null)
    {
        _frog = frog;
    ...
    private void StartHop()
    {
        ...
        // 调试：确认起跳指令已执行及实际速度（由 FrogBT 的 Enable Debug Log 控制）
